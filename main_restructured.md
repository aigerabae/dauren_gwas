...
## 10.1 Naive Bonferroni on LD-Pruned Variant Set
...
## 12.1 Power at Genome-Wide Significance
...
## 12.2 Power at Suggestive Significance & Suggestive-Threshold Rationale
...
## 10.2 Effective Number of Tests — simpleM (Autosomes)

*(Note: the block below continues the multiple-testing-correction work from Section 10 above — kept here in original position to avoid reordering content.)*

# 13. Sensitivity Analyses — Alternative Models

## 13.1 Sex-Unadjusted Model, Full Firth vs. Firth-Fallback, Permutation, Genotypic Model
...
# 14. Functional Annotation of Top Hits
...
# 15. Polygenic Risk Score (PRS)

## 15.1 Asia-Base PRS — Liftover, Reconciliation, Clumping & Scoring
...
## 15.2 Europe-Base PRS — Clumping & Scoring
...
## 15.3 Asia vs. Europe PRS Comparison & Summary
...
# 16. Gene-Based Testing (MAGMA)

## 16.1 Kazakh WGS Reference Panel Prep & Annotation
...
## 16.2 Gene-Based Association Test & Cross-Referencing with GWAS SNP p-values
